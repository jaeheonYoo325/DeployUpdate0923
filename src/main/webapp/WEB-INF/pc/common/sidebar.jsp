...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		...
		<ul class="sidebar navbar-nav">
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
	          <h6 class="dropdown-header">배포 결재선</h6>
	          <a class="dropdown-item" href="<c:url value='/employee/myDeployWillDeploy.do' />">배포 결재</a>
	          <a class="dropdown-item" href="<c:url value='/employee/myDeployDeployed.do' />">배포 결재내역</a>
	        </div>
	      </li>
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
	          <h6 class="dropdown-header">사원 관리</h6>
	          <a class="dropdown-item" href="<c:url value='/employee/employeeRegist.do' />">사원등록</a>	          
	        </div>
	      </li>	      
		</ul>